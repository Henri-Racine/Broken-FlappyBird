...
namespace FlappyBird
{
    ...
    {
        public GameObject collumPrefab;     // The column prefab we want to spawn
        ...
        private int currentCollum = 0;      // Index of the current column in the collection
        ...
        void Start()
        {
            ...
            for (int i = 0; i < columnPoolSize; i++)
            {
                ...
                columns[i] = Instantiate(collumPrefab, standbyPos, Quaternion.identity);
            }
        }
